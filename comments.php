...
<?php else : ?>
							...
							<p id="comment-notes"> <?php if ($req) _e( 'There are no required fields', 'sandbox' ) ?></p>
...
<?php endif // REFERENCE: * if ( $user_ID ) ?>
							...
							<div class="form-textarea"><textarea id="comment" name="comment" class="text required" style="width: 100%" rows="8" tabindex="6"></textarea></div>
